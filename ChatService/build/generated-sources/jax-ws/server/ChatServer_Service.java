 ...
 * 
 */
@WebServiceClient(name = "ChatServer", targetNamespace = "http://Server/", wsdlLocation = "http://localhost:9090/UserService/ChatServer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CHATSERVER_QNAME = new QName("http://Server/", "ChatServer");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/UserService/ChatServer?wsdl");
    ...
    public ChatServer getChatServerPort() {
        return super.getPort(new QName("http://Server/", "ChatServerPort"), ChatServer.class);
    }
    ...
    public ChatServer getChatServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Server/", "ChatServerPort"), ChatServer.class, features);
    }
